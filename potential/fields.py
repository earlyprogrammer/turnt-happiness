...
def draw_goal(x, y):
	return 'set object 1 circle at %s, %s size first 2 fc rgb "blue"\n' % (x,y)
...
def make_potential_fields(OBSTACLES, WS, goal, field_function):
	global VEC_LEN, WORLDSIZE
	WORLDSIZE = WS
	...
	print >>outfile, draw_goal(goal[0], goal[1])
